...
\fancyfoot[C]{\thepage} % Mantiene il numero di pagina al centro del piè di paginaa
...
\include{chapters/chapter-1/chapter1} % Capitolo 1
\include{chapters/chapter-2/chapter2} % Capitolo 2
\include{chapters/chapter-3/chapter3} % Capitolo 3
\include{chapters/chapter-4/chapter4} % Capitolo 4
\include{chapters/chapter-8/chapter8} % Capitolo 8
\include{chapters/chapter-5/chapter5} % Capitolo 5
\include{chapters/chapter-6/chapter6} % Capitolo 6
\include{chapters/chapter-7/chapter7} % Capitolo 7
% Aggiungi altri file di capitoli se necessario

\include{chapters/esercitazioni/Esercitazioni}

\appendix
\include{chapters/appendice/appendice}
